...
Prepare a clean public source repository at **kellygold/weekaboo**, authorized by Kelly once publication checks pass. Do not confuse this with permission to publish binaries, submit to stores, deploy the website, notarize or incur charges. At this checkpoint this working repository still has no commits or remote, and GitHub returned 404 for that destination. No push yet.
